...
import CustomerSignUp from '../customer/CustomerSighup'
...
export default function Header() {
  ...
  />
          ...
          <div className="hidden md:flex flex-1 max-w-md">
            <div className="relative w-full">
              ...
              <input
                type="text"
                placeholder="Search"
                className="w-full rounded-full bg-gray-100 py-3 pl-10 pr-4 text-sm outline-none focus:ring-2 focus:ring-green-500"
              />
            </div>
          </div>
    ...
    />
              ...
              {langOpen && (
                <ul className="absolute left-0 top-full mt-2 w-40 rounded-md bg-white shadow-lg z-50">
                  {languages.map((lang) => (
                    <li key={lang.code}>
                      <button
                        onClick={() => {
            ...
            <button
              className="flex items-center gap-2 rounded-full bg-gray-100 px-6 py-3 text-sm text-define-black"
            ...
            <Link
              href=""
              className="flex items-center gap-2 rounded-full bg-green-600 px-6 py-3 text-sm text-white text-define-black"
            >
  ...
  {langOpen && (
    ...
    <div className="flex flex-col gap-3">
      ...
      <button
        ...
        className="flex items-center gap-2 rounded-lg bg-gray-100 px-4 py-3 text-sm text-define-black"
      >
        Login <User size={18} />
      </button>
